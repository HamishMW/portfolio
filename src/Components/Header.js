  ...
  render() {
    return (
      <header className="Header">
        <div className="Header__logo"><Monogram /></div>
        <nav className="Header__nav">
          <div className="Header__nav-items">
            <a className="Header__nav-link" href="/">Projects</a>
            <a className="Header__nav-link" href="/">Details</a>
          </div>
          <div className="Header__nav-icons">
            <a className="Header__nav-icon" href="/">
              <svg fill="rgba(var(--color-text), 0.6)" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
